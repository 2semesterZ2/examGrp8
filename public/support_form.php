		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<fieldset>
				...
				<legend id="personal_inf">Personal information</legend>
					<form class="contact_form" method="post" action="<?= $_SERVER['PHP_SELF']; ?>">
						...
						<div class="form-group">
							...
							<input id="inputAddList" type="checkbox" name="AssList">Add me to email blast
						    </label>
						    </div>
						</div>
				...
				<legend id="post_inf">Post</legend>
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" id="inputTitle" placeholder="Post title" name="title">
						</div>

						<div class="form-group">
							<label for="inputKeywords">Keywords</label>
							<input class="form-control" type="text" id="inputKeywords" placeholder="Keywords" name="keywords">
						</div>
